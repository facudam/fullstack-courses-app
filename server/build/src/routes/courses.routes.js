...
router.post('/api/courses', courses_controllers_1.upload.single('image'), courses_controllers_1.createCourse);
router.patch('/api/courses/:id', courses_controllers_1.upload.single('image'), courses_controllers_1.updateCourse);
